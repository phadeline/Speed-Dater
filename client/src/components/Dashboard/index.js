  ...
  return (
    <container id="case">
      <section id="profileSnip">
        ...
        <p id="dashGender" class="dashDetails">
          {myBio.gender} <span id="dashAge">, 28 </span>
        </p>
        <p id="dashOrientation" class="dashDetails">
          {myPreference.sexOrientation}
        </p>
        <p id="dashLocation" class="dashDetails">
          {myBio.location}
        </p>
            ...
            myUser.connections.map((connection) => {
              return (
                <div className="eachfriend">
                  <a href="/profile/{connection._id}">{connection.username}</a>
                </div>
              );
            })}
